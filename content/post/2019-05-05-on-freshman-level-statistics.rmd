...
However, it should be emphasized that the practice I've used **depends on the context of the situation** in general. There is not one statistical procedure which I would recommend using in absolutely every situation when it comes to comparing means.
